...
<h3 style="text-align: center;" class="pink-text">Login!</h3>
	<form method="POST">
		...
		<input type="submit" name="login" value="Login" class="btn brown" style="width: 100%;">
        <center><a href="login.php"><font color="btn aqua">Login masyarakat</font></center>
	</form>
</div>
<?php 
